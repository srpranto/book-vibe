    ...
    <section className="px-4 py-8 md:py-14">
      <div className="container mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-4xl border border-[#EADBCE] bg-linear-to-br from-[#F7EFE7] via-[#FAF6F0] to-[#ECE0D3] px-6 py-14 text-center shadow-xs ring-1 ring-[#EADBCE]/50 md:px-16 md:py-20">
          {/* Ambient Warm Coffee Lighting Orbs */}
          ...
          <div className="relative mx-auto max-w-3xl space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              ...
              <Link
                href="#books"
                className="inline-flex items-center gap-2 rounded-xl border border-[#DCC8B6] bg-white/90 px-7 py-4 text-base font-bold text-[#4A2E18] shadow-xs backdrop-blur-xs transition duration-300 hover:border-[#8B5A2B] hover:bg-[#F5ECE3] hover:text-[#8B5A2B]"
              >
