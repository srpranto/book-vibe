        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 max-w-sm text-sm leading-6 text-[#D8C7BA]">
              A cozy sanctuary for passionate readers and coffee thinkers. Grab
              a warm cup, sink into a comfortable armchair, and discover your
              next literary companion.
            </p>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-[#D8C7BA]">
              ...
              <li>
                <Link href="/allbooks" className="transition hover:text-white">
                  All Books (100)
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="mt-2 text-xs italic text-[#C4B2A5]">
              &ldquo;A cup of coffee and a great book is the shortest escape to
              another world.&rdquo;
            </p>
          </div>
        </div>
